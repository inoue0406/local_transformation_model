...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  m.def("cal_pc_grid_index", &cal_pc_grid_index, "bilinear_cal_pc_grid_index");
  m.def("cal_weight_sum", &cal_weight_sum, "bilinear_cal_weight_sum");
  m.def("cal_grid_value", &cal_grid_value, "bilinear_cal_grid_value");
  m.def("cal_pc_grad", &cal_pc_grad, "bilinear_cal_pc_grad");
  m.def("cal_pc_value_grad", &cal_pc_value_grad, "bilinear_cal_pc_value_grad");
}
