...
#        }
    ...
    hparam_dict = {
        ...
        'model_mode':'run',
        'data_scaling':'linear',
        'data_path':'sagemaker-dir-light/data_kanto/',
        'image_size':200,
        'pc_size':100,
        'valid_data_path':'sagemaker-dir-light/data_kanto/ ',
        'train_path':'sagemaker-dir-light/train_simple_JMARadar.csv ',
        'valid_path':'sagemaker-dir-light/valid_simple_JMARadar.csv ',
        'test_path':'sagemaker-dir-light/valid_simple_JMARadar.csv ',
        'result_path':' result_tstrun',
        'tdim_use': 12,
        'tdim_loss': 1,
        'learning_rate': 0.0001,
