...
if __name__ == '__main__':
    ...
    # Adjust for SageMaker directory
    data_root = os.environ['SM_CHANNEL_TRAINING']
    opt.data_path = os.path.join(data_root, opt.data_path)
    opt.valid_data_path = os.path.join(data_root, opt.valid_data_path)
    opt.train_path = os.path.join(data_root, opt.train_path)
    opt.valid_path = os.path.join(data_root, opt.valid_path)
    opt.test_path = os.path.join(data_root, opt.test_path)
    opt.result_path = os.path.join(data_root, opt.result_path)
    print('opt.data_path',opt.data_path)
    print('opt.valid_data_path',opt.valid_data_path)
    print('opt.train_path',opt.train_path)
    print('opt.valid_path',opt.valid_path)
    print('opt.test_path',opt.test_path)
