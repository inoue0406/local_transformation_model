...
#       --train_path ../data/train_alljapan_2014_JMARadar.csv \
...
python ../src/main_trajGRU_jma.py --model_name trajgru\
       ...
       --data_path ../data/data_alljapan_2019/ --image_size 200\
       --valid_data_path ../data/data_kanto/ \
       --train_path ../data/train_alljapan_2019_JMARadar.csv \
       ...
       --batch_size 1 --n_epochs 20 --n_threads 4 --checkpoint 10 \
       --loss_function MSE\
