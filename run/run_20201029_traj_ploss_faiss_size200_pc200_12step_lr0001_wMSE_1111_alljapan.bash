...
case="result_20201029_traj_ploss_faiss_size200_pc200_12step_lr0002_wMSE_1111_alljapan"
...
python ../src/main_trajGRU_jma_ploss.py --model_name trajgru_ploss\
       ...
       --result_path $case --tdim_use 12 --tdim_loss 12 --learning_rate 0.00001 --lr_decay 0.8 \
       --batch_size 10 --n_epochs 10 --n_threads 4 --checkpoint 5 \
