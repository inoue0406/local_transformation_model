...
case="result_20200628_traj_el_nearest_size128_lr002"
#case="result_20200628_traj_el_nearest_size200_lr002"
...
#       --result_path $case --tdim_use 12 --learning_rate 0.002 --lr_decay 0.8 \
...
#case="result_20200621_traj_el_size200_lr002"
#
## running script for Rainfall Prediction with ConvLSTM
#python ../src/main_trajGRU_jma.py --model_name trajgru_el \
#       --dataset radarJMA --model_mode run --data_scaling linear\
