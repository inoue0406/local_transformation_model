...
case="result_20200419_LTM_size128_ch2"
...
python ../src/main_LTM_jma.py --data_path ../data/data_kanto_resize/ \
       ...
       --result_path $case --tdim_use 12 --learning_rate 0.002 --lr_decay 0.7 \
       --batch_size 20 --n_epochs 20 --n_threads 4 --checkpoint 10 \
       --optimizer adam --model_name ltm --in_channels 2

case="result_20200419_LTM_size128_ch3"
...
case="result_20200419_LTM_size128_ch5"
...
python ../src/main_LTM_jma.py --data_path ../data/data_kanto_resize/ \
       ...
       --result_path $case --tdim_use 12 --learning_rate 0.002 --lr_decay 0.7 \
       --batch_size 20 --n_epochs 20 --n_threads 4 --checkpoint 10 \
       --optimizer adam --model_name ltm --in_channels 5

case="result_20200419_LTM_size128_ch12"
...
python ../src/main_LTM_jma.py --data_path ../data/data_kanto_resize/ \
       ...
       --result_path $case --tdim_use 12 --learning_rate 0.002 --lr_decay 0.7 \
       --batch_size 20 --n_epochs 20 --n_threads 4 --checkpoint 10 \
       --optimizer adam --model_name ltm --in_channels 12
