...
case="result_20200504_traj_trajgru_size128_weight"

# running script for Rainfall Prediction with ConvLSTM
python ../src/main_trajGRU_jma.py --model_name trajgru --data_path ../data/data_kanto_resize/ \
       ...
       --result_path $case --tdim_use 12 --learning_rate 0.001 --lr_decay 0.7 \
       --batch_size 10 --n_epochs 20 --n_threads 4 --checkpoint 10 \
       --hidden_channels 8 --kernel_size 3 --optimizer adam --loss_function Weighted_MSE_MAE
# png output
