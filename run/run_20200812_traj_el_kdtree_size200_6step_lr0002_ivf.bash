...
case="result_20200812_traj_el_faiss_size200_6step_lr0001_ivf"
...
python ../src/main_trajGRU_jma.py --model_name trajgru_el \
       ...
       --result_path $case --tdim_use 12 --tdim_loss 6 --learning_rate 0.0001 --lr_decay 0.8 \
       ...
       --transfer_path  ../run/result_20200808_traj_el_faiss_size200_1step_lr0002_ivf/trained_CLSTM.model \
