...
case="result_20200810_traj_el_faiss_size200_pc100_1step_lr0001_ivf"
...
case="result_20200810_traj_el_faiss_size200_pc100_12step_lr0001_trans"
...
python ../src/main_trajGRU_jma.py --model_name trajgru_el \
       ...
       --loss_function MSE --interp_type nearest\
       --hidden_channels 5 --kernel_size 3 --optimizer adam
       --transfer_path  ../run/result_20200810_traj_el_faiss_size200_pc100_1step_lr0001_ivf/trained_CLSTM.model \
